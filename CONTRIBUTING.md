...
Thanks for your interest in working on the Creatures of Sonaria PvP Calculator.
...
The directory tree is in the [README](README.md#repository-layout); its [Architecture](README.md#architecture) section maps where each part of the engine and its bridge lives.

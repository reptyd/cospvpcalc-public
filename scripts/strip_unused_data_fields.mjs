 ...
 *
 * Round 25 (audit #45): the previous build pulled ~70 kB of human-readable
 * descriptions and wiki-scraping artifacts into the bundle that no code
 * ever reads. The biggest offender was the parsed.rawDescription field on

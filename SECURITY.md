...
You will get an acknowledgement within 7 days. High-severity issues (RCE, persistent XSS, data leakage) are prioritized over self-DoS or theoretical issues.

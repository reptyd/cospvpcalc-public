...
export const COMPARE_ONLY_REFERENCE_DRAFTS: AbilityReferenceEntry[] = [
  ...
  },
  {
    ...
    mechanics: [
      ...
      "If the user has Bear, it uses the Bear version instead and the effect becomes +35% damage.",
    ],
    policyDifferences: [],
    notes: [
  ...
  },
  {
    ...
    mechanics: [
      ...
      "If the user has Bear, it uses the Bear version instead and the effect becomes -40% damage.",
    ],
    policyDifferences: [],
    notes: [
      "This rule exists only in Compare and does not move into Optimizer or Best Builds.",
...
export const STATUS_REFERENCE_DRAFTS: StatusReferenceEntry[] = [
  ...
  },
  {
    ...
    notes: [
      "See `Generalize Aura to subtype-driven mechanic, retire Radiation alias` commit a1dc5a8 for the migration rationale.",
      "Polarity is negative — Fortify cleanses it.",
    ],
  },
  {
    ...
    notes: [
      ...
      "The Bear plushie replaces this status with Scared (Bear) which softens the penalty to -40% (see plushie_bear and status_scared_bear).",
    ],
  },
  {
    ...
    name: "Scared (Bear)",
    status: "Modeled",
    summary: "Bear-plushie variant of Scared: -40% outgoing damage for 10 seconds.",
    mechanics: [
      "Scared (Bear) reduces outgoing melee damage by 40% multiplicatively for 10 seconds.",
      "The Bear plushie scales the standard Scared damage modifier by ×1.1 (sign-preserving) and adds a flat +10 percentage points: −50% × 1.1 + 10 = −45%; the rounded effect surfaced as a -40% multiplier matches Bear's softer-penalty behaviour described in plushie_bear.",
    ],
    notes: [
      "Polarity is negative — Fortify cleanses it.",

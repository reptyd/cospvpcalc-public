  ...
  return (
    <div className="sb-form">
      ...
      <div className="sb-form__row">
        ...
        <button className="sb-form__apply" type="button" aria-label={`Apply status to side ${side}`} onClick={() => onApplyStatus(side, statusId, stacks)}>Apply</button>
      </div>
      <div className="sb-form__row">
        ...
        <button className="sb-form__apply" type="button" aria-label={`Apply meter value to side ${side}`} onClick={() => onApplyMeter(side, meter, meterValue)}>Apply</button>
      </div>
    </div>
  );
}

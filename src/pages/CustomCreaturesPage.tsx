...
type BuilderState = {
   ...
   * unknown ids drop silently. Sprint 5 wiring (engine consults
   * these per side) lives in the policy bridge.
   */
  userAbilityIds: string[];
  /** Phase 7 / G7: user-authored breath profile. null = use the named
...
function collectStatusOptions(): StatusPickerOption[] {
  // P5 (2026-05-18): consume the shared `statusCatalog` directly.
  ...
  // was missing — exactly the symptom the user reported on the
      ...
      <div className="panel-grid">
        <div className="panel-block">
          ...
          <div className="custom-creature-editor-section">
            ...
            <p className="muted">
              Phase 7: author a breath weapon directly instead of picking a known
                  ...
                  <div className="custom-creature-picker-copy">
                    ...
                    {status.details.length > 0 ? (
                      <span className="muted custom-status-inline-details">
                        {/* P5: visible bullet separator. Pre-2026-05-18
                            ...
                            producing the "overlap" the user reported. */}
                        {status.details.join(" • ")}
                      </span>
                    ) : null}
                  </div>

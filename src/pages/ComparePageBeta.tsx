...
function CreatureSheet({ side, stats, getIcon, airRuleCooldownSec, activeTempBuffIds, onPick }: {
  ...
  /** Effective shared bite cooldown when the Special Air PvP Rule is on, else null. */
      ...
      <details className="cb-rawcards" open>
        ...
        <div className="cb-sheets">
          <CreatureSheet
            ...
            airRuleCooldownSec={c.compareAirRuleEnabled ? c.compareAirRuleCooldownSec : null}

...
export type RustSimpleCombatantStats = {
  ...
  /**
   * Custom-ability ids attached to this side. Sprint 5 wiring: the
  ...
  /**
   * Phase 5 / G8: read-only creature identity surfaced to the
...
export type RustAbilityPolicyOverrides = Partial<{
  ...
  // Round 42 / A11: per-fight active-level override for user
...
export type RustComposableAbilityConfig = {
  ...
  // --- Round 32 / A5: compare-page environment flags for user abilities ---
   ...
   * today's behavior. `secondaryOnly` replaces the pre-P3 TS-side

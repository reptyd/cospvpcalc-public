...
// Statuses the engine fully models as a carried/resisted ailment, so an
// Attack/Block/Defensive/Aura/Totem/Trail/Lance ability carrying ONLY these
// keeps its creature eligible for the Rust composable engine (Best Builds /
// Optimizer). A new main ailment (e.g. Radiation) MUST be added here or every
// creature that gains a "<X> Attack/Block/..." for it silently becomes
// ineligible and its matchups stop running. Kept in sync with the
// Attack/Block/Defensive maps in tools/effects_catalog_rules.ts.
export const SUPPORTED_GENERIC_STATUS_IDS = new Set([
  "Bleed_Status",
  "Burn_Status",
  "Corrosion_Status",
  "Poison_Status",

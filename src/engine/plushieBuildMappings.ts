...
const GENERIC_PLUSHIE_OVERRIDES: Record<string, PlushieModifierDef[]> = {
  ...
  // The wiki files both under one appetite channel, but the game splits them:
  // Euvatops multiplies the Hunger stat only, Aerodon the Thirst stat only.
  Euvatops: [
    { stat: "hungerDrainPct", op: "addPct", value: -15, note: "Euvatops override" },
  ],
  Aerodon: [
    { stat: "thirstDrainPct", op: "addPct", value: -15, note: "Aerodon override" },
  ],
  Ghost: [
  ...
  "Frost Dragon": [
    ...
    { stat: "appetiteDrainPct", op: "addPct", value: -5, note: "Frost Dragon override" },
  ],
  Seal: [
    { stat: "moistureTimePct", op: "addPct", value: 15, note: "Seal override" },
  ],
  Sparkler: [

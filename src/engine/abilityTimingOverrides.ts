 ...
 * behavior.
 *
 * Hunker WAS pinned to ReallyFast as a workaround for the pre-P4
 * Ideal flicker bug (long fights → tick-by-tick on/off). After P4
 * landed (hysteresis dead-zone + event-discrete adaptive window),

...
//
// The TypeScript combat simulator that used to live here was deleted
// when the deprecated fallback path (`legacySimulateFight_DEPRECATED`)
// became unreachable. The Rust crate in `wasm-engine/` is the

 ...
 *                     on-hit ailments. Replaces the pre-P3 binary
...
export type CreatureRuntime = {
  ...
  /**
   * Phase 7 / G7: user-authored breath profile (custom-creature editor).
...
/**
 * User-authored breath profile (Custom Abilities v2 Phase 7 / G7). Mirrors
...
/**
 * Constructor-coverage lock for custom breath (Phase 8 / G7).
 *
...
export type FinalStats = CreatureStats & {
  ...
  /** Phase 7 / G7: carried from `CreatureRuntime.customBreathProfile` by

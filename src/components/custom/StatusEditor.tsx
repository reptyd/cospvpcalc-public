...
/**
 * Dual-mode editor for a user-defined status - the status twin of
 * `AbilityEditor`. The textual `statusDsl`
...
/**
 * Programmable fields the Visual editor surfaces through the block

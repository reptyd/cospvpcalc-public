 ...
 *
 * The old parametric Periodic-tick and Combat-modifier sections (and their `fx`
...
export function StatusVisualEditor({
  ...
  // spec actually carries render as stacks; x removes one entirely.
 ...
 * (regen/incoming/outgoing/bite all x1 / 0), so the section stays out of the

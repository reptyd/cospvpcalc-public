...
// Round 41 / A11: levels + scaling-table editor. Collapses entirely
// when the ability is single-level with no scaling (the pre-A11
    ...
    <>
      <div className="scratch-strip-row">
        ...
        <button
          ...
          title="Reset back to single-level (pre-A11)"
        >
          Remove levels
        </button>
      </div>
...
function BlockBody({
  ...
  switch (effect.kind) {
    ...
    case "apply_statuses_to_target":
      // Round 35 / A3: array variant — render an opaque summary in
...
/** Live list of registered custom-status ids (Phase 6 / G6) so the

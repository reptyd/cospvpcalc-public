...
const CANDIDATE_SET_PRESETS: PresetCandidates[] = [
  ...
  { label: "Fast [0, 1, 3]", values: [0, 1, 3], description: "Built-in Fast: three candidates, 15 s horizon." },
  { label: "Burst [0, 0.1, 0.25, 0.5, 1]", values: [0, 0.1, 0.25, 0.5, 1], description: "Tight reactive window - useful for combo timing." },
  { label: "SemiIdeal [0, 0.5, 1, 2, 4, 8]", values: [0, 0.5, 1, 2, 4, 8], description: "Built-in SemiIdeal: six candidates, 24 s horizon." },
  { label: "Ideal [0, 0.25, 0.5, 1, 1.5, 2, 3, 4, 6, 8, 12]", values: [0, 0.25, 0.5, 1, 1.5, 2, 3, 4, 6, 8, 12], description: "Built-in Ideal: eleven candidates, 45 s horizon." },
...
const HORIZON_PRESETS: PresetNumber[] = [
  ...
  { label: "15s - default", value: 15, description: "Built-in Fast horizon." },
  { label: "45s - Ideal", value: 45, description: "Built-in Ideal horizon." },
 ...
 *   var <op> const   (op is one of lt/lte/gt/gte/eq/ne).
...
function DraggablePaletteTile({
  ...
  // scroll the palette. The grip handle is the only mobile drag-source.

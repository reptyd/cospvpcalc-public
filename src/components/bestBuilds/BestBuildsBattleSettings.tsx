          ...
          <div className="bb-settings-global-grid__full">
            ...
            {settings.global.airRuleEnabled ? (
              <div className="compare-air-body">
                ...
                <div className={`compare-air-sides${settings.global.airRuleCooldownLinked ? " is-single" : ""}`}>
                  <div className="field">
                    <label htmlFor="bb-air-cd-a">
                      {settings.global.airRuleCooldownLinked ? "Bite cooldown (sec)" : "Your creature — cooldown (sec)"}
                    </label>
                    <SmartNumericInput
                      id="bb-air-cd-a"
                  ...
                  {!settings.global.airRuleCooldownLinked ? (
                    <div className="field">
                      <label htmlFor="bb-air-cd-b">Opponent — cooldown (sec)</label>
                      <SmartNumericInput
                        id="bb-air-cd-b"
            ...
            {settings.global.aerialDodgeEnabled ? (
              <div className="compare-air-body">
                <div className="compare-air-sides">
                  <div className="field">
                    <label htmlFor="bb-dodge-a">Your creature — chance to be hit</label>
                    <SmartNumericInput
                      id="bb-dodge-a"
                  ...
                  <div className="field">
                    <label htmlFor="bb-dodge-b">Opponent — chance to be hit</label>
                    <SmartNumericInput
                      id="bb-dodge-b"
                ...
                <div className="note">
                  Grounded creatures are always hit. Wing Shredder (Shredded Wings) grounds an airborne creature, so attacks on it always land. Even pattern is the deterministic default; real random rides a fixed seed here, so a run stays reproducible.
                </div>
              </div>
            ) : null}
          </div>

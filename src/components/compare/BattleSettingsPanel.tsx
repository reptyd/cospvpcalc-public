          ...
          <div className="compare-air-body">
            ...
            {compareAirRuleCooldownLinked ? (
              <div className="compare-air-sides is-single">
                <div className="field">
                  <label htmlFor="compare-air-cd-a">Bite cadence (sec)</label>
                  ...
                  <div className="compare-air-readout">
                    Both sides bite every <b>{compareAirRuleCooldownSec} seconds</b>.
                  </div>
                </div>
              </div>
            ) : (
              <div className="compare-air-sides">
                <CadenceSideField
                  name={creatureA?.name ?? "Creature A"}
                  value={compareAirRuleCooldownSec}
                  onChange={onCompareAirRuleCooldownSecChange}
                  isB={false}
                >
                  <AirRuleCooldownInput value={compareAirRuleCooldownSec} onChange={onCompareAirRuleCooldownSecChange} />
                </CadenceSideField>
                <CadenceSideField
                  name={creatureB?.name ?? "Creature B"}
                  value={compareAirRuleCooldownSecB}
                  onChange={onCompareAirRuleCooldownSecBChange}
                  isB
                >
                  <AirRuleCooldownInput value={compareAirRuleCooldownSecB} onChange={onCompareAirRuleCooldownSecBChange} />
                </CadenceSideField>
              </div>
            )}
          </div>
        ...
        {compareAerialDodgeEnabled ? (
          <div className="compare-air-body">
            <div className="compare-air-sides">
              <DodgeSideField
                name={creatureA?.name ?? "Creature A"}
                value={compareAerialDodgeHitChancePctA}
                onChange={onCompareAerialDodgeHitChancePctAChange}
                isB={false}
              >
                <AerialDodgePctInput value={compareAerialDodgeHitChancePctA} onChange={onCompareAerialDodgeHitChancePctAChange} />
              </DodgeSideField>
              <DodgeSideField
                name={creatureB?.name ?? "Creature B"}
                value={compareAerialDodgeHitChancePctB}
                onChange={onCompareAerialDodgeHitChancePctBChange}
                isB
              >
                <AerialDodgePctInput value={compareAerialDodgeHitChancePctB} onChange={onCompareAerialDodgeHitChancePctBChange} />
              </DodgeSideField>
            </div>
            <div className="field">
...
// Draft input for the Dodge Chance per-side hit chance (0..100), same

...
type OptimizerBasicSettingsProps = {
  ...
  optimizationGoal: "lexicographic" | "ttk" | "dps" | "survival";
  setOptimizationGoal: (value: "lexicographic" | "ttk" | "dps" | "survival") => void;
    ...
    <>
      ...
      <div className="field">
        ...
        <select aria-label="Optimization Goal" value={optimizationGoal} onChange={(e) => setOptimizationGoal(e.target.value as typeof optimizationGoal)}>
          ...
          <option value="ttk">Fastest kill (TTK)</option>
          <option value="dps">Max DPS</option>
          <option value="survival">Max survival time</option>
        </select>
      </div>
      <div className="field">

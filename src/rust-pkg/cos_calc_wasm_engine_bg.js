 ...
 * @returns {any}
 */
export function capture_defensive_pin_schedule_js(attacker, defender, attacker_breath, defender_breath, ability_config, max_time_sec) {
    const ret = wasm.capture_defensive_pin_schedule_js(attacker, defender, attacker_breath, defender_breath, ability_config, max_time_sec);
    if (ret[2]) {
        throw takeFromExternrefTable0(ret[1]);
    }
    return takeFromExternrefTable0(ret[0]);
 ...
 * @returns {any}
 */
export function sandbox_apply_meter_js(id, payload) {
    const ret = wasm.sandbox_apply_meter_js(id, payload);
    if (ret[2]) {
        throw takeFromExternrefTable0(ret[1]);
    }
    return takeFromExternrefTable0(ret[0]);
 ...
 * @returns {any}
 */
export function sandbox_force_posture_js(id, payload) {
    const ret = wasm.sandbox_force_posture_js(id, payload);
    if (ret[2]) {
        throw takeFromExternrefTable0(ret[1]);
    }
    return takeFromExternrefTable0(ret[0]);
 ...
 * @returns {any}
 */
export function sandbox_reconfigure_js(id, payload) {
    const ret = wasm.sandbox_reconfigure_js(id, payload);
    if (ret[2]) {
        throw takeFromExternrefTable0(ret[1]);
    }
    return takeFromExternrefTable0(ret[0]);
 ...
 * @returns {any}
 */
export function sandbox_set_automation_mode_js(id, payload) {
    const ret = wasm.sandbox_set_automation_mode_js(id, payload);
    if (ret[2]) {
        throw takeFromExternrefTable0(ret[1]);
    }
    return takeFromExternrefTable0(ret[0]);
 ...
 * @returns {any}
 */
export function sandbox_set_bad_omen_outcomes_js(id, payload) {
    const ret = wasm.sandbox_set_bad_omen_outcomes_js(id, payload);
    if (ret[2]) {
        throw takeFromExternrefTable0(ret[1]);
    }
    return takeFromExternrefTable0(ret[0]);
 ...
 * @returns {any}
 */
export function simulate_composable_matchup_batch_js(batch) {
    const ret = wasm.simulate_composable_matchup_batch_js(batch);
    if (ret[2]) {
        throw takeFromExternrefTable0(ret[1]);
    }
    return takeFromExternrefTable0(ret[0]);
 ...
 * @param {any} defender_breath
 * @param {any} ability_config
 * @param {any} pinned_schedule
 * @param {number} max_time_sec
 * @param {boolean | null} [record_trace]
 * @returns {any}
 */
export function simulate_composable_matchup_pinned_js(attacker, defender, attacker_breath, defender_breath, ability_config, pinned_schedule, max_time_sec, record_trace) {
    const ret = wasm.simulate_composable_matchup_pinned_js(attacker, defender, attacker_breath, defender_breath, ability_config, pinned_schedule, max_time_sec, isLikeNone(record_trace) ? 0xFFFFFF : record_trace ? 1 : 0);
    if (ret[2]) {
        throw takeFromExternrefTable0(ret[1]);
    }
    return takeFromExternrefTable0(ret[0]);

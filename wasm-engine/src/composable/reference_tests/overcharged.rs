//! Reference: ability_overcharged
//!
//! "Overcharged" is generated through `createOutOfModelAbilityEntry` in
...
//! exists so the coverage gate sees the [REF:ability_overcharged] marker.

#[test]
fn not_modeled_in_stand_and_fight_combat() {
    // [REF:ability_overcharged]

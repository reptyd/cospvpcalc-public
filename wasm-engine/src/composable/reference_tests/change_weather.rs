//! Reference: ability_change_weather
//!
//! "change_weather" is generated through `createOutOfModelAbilityEntry` in
...
//! exists so the coverage gate sees the [REF:ability_change_weather] marker.

#[test]
fn not_modeled_in_stand_and_fight_combat() {
    // [REF:ability_change_weather]

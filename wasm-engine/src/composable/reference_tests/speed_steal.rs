//! Reference: ability_speed_steal
//!
//! "speed_steal" is generated through `createOutOfModelAbilityEntry`
...
//! speed_steal path; this test exists so the coverage gate sees
//! the [REF:ability_speed_steal] marker.

#[test]
fn not_modeled_in_stand_and_fight_combat() {
    // [REF:ability_speed_steal]

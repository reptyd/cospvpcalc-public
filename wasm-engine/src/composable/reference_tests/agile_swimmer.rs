//! Reference: ability_agile_swimmer
//!
//! "agile_swimmer" is generated through `createOutOfModelAbilityEntry` in
...
//! exists so the coverage gate sees the [REF:ability_agile_swimmer] marker.

#[test]
fn not_modeled_in_stand_and_fight_combat() {
    // [REF:ability_agile_swimmer]

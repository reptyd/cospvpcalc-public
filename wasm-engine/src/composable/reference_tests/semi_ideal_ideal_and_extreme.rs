//! Reference: policy_semi_ideal_ideal_and_extreme
//!
...
//! placeholder so the coverage gate sees the [REF:policy_semi_ideal_ideal_and_extreme]
//! marker.

#[test]
fn behaviour_is_covered_by_per_ability_reference_tests() {
    // [REF:policy_semi_ideal_ideal_and_extreme]

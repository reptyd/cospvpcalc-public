//! Reference: ability_area_water_restore
//!
//! "area_water_restore" is generated through `createOutOfModelAbilityEntry` in
...
//! exists so the coverage gate sees the [REF:ability_area_water_restore] marker.

#[test]
fn not_modeled_in_stand_and_fight_combat() {
    // [REF:ability_area_water_restore]

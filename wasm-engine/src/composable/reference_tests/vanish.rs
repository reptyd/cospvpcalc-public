//! Reference: ability_vanish
//!
//! "Vanish" is generated through `createOutOfModelAbilityEntry` in
...
//! model. The Rust engine has no Vanish path; this test exists so the
//! coverage gate sees the [REF:ability_vanish] marker.

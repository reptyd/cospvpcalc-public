//! Reference: ability_burrower
//!
//! "burrower" is generated through `createOutOfModelAbilityEntry` in
...
//! exists so the coverage gate sees the [REF:ability_burrower] marker.

#[test]
fn not_modeled_in_stand_and_fight_combat() {
    // [REF:ability_burrower]

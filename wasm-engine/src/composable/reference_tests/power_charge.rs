...
//! `mod.rs:4918-4926` (Shredded_Wings x 2 apply on the first bite,
...
fn first_melee_hit_gains_fifty_percent_damage_and_two_shredded_wings() {
    ...
    // Bullets 1 + 2: "In Compare, Power Charge changes only the first melee
    // hit." + "That hit gains +50% damage and applies 2 stacks of Shredded
    // Wings."

...
fn caps_a_single_source_to_listed_percent_of_max_hp() {
    ...
    // Bullet 1 + 2: "Unbreakable uses the user's listed value as a per-source
    // damage cap." + "For example, Unbreakable (12) means one hit, tick,
    // reflect, recoil, or ability self-cost cannot remove more than 12% of the
    // user's max HP at once."

...
//! - Life Leech melee + breath in `composable/mod.rs:5015-5038`,
...
fn blocks_blessings_boon_heal_but_keeps_natural_regen() {
    ...
    // Blessings_Boon x 5 stacks. In one, attacker also carries a
    // Heartbroken_Status x 5 stacks at start; in the other, no
...
fn natural_regen_is_not_blocked_by_heartbroken() {
    ...
    // health_regen=5 + Heartbroken x 5. The 15 s regen tick at t=15

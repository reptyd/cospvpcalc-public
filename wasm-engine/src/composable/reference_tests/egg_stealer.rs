//! Reference: ability_egg_stealer
//!
//! "egg_stealer" is generated through `createOutOfModelAbilityEntry` in
...
//! exists so the coverage gate sees the [REF:ability_egg_stealer] marker.

#[test]
fn not_modeled_in_stand_and_fight_combat() {
    // [REF:ability_egg_stealer]

...
mod policy {
    ...
    // 2026-05-21: P9 engine-replay moves the live posture decision to
    ...
    fn policy_lays_for_regen_ticks_korathos_full_regen_build_vs_golgaroth() {
        ...
        // is the natural ceiling. Earlier P5-era expectation of ≥3
...
fn policy_does_not_flip_outcome_in_long_fight_with_cause_fear() {
    ...
    // Module B sim used a 20 s horizon and didn't model the bite-lock
    // during settled non-Standing. Over a 60+ s fight, Module B's
    ...
    // pass None here; the regression manifests purely from Module B's

...
pub(in super::super) fn process_phase_12_status_dot_ticks(
    ...
    if !ctx.a.statuses.is_empty() {
        ...
        // G3: route this iteration's DOT total through the pre-damage hook
        ...
        // Round 36 / A10: tag iter mask if any DOT actually damaged A.
        ...
        // 2026-05-12: DOT damage now flows into combat counters (B4),
        // sliding-window logs (B2), and raw-damage iter totals (A10b).
    ...
    if !ctx.b.statuses.is_empty() {
        ...
        // G3: route B's iteration DOT total through the pre-damage hook
        ...
        // Round 36 / A10: B took DOT damage → bit on B, A "dealt" it.
                    ...
                    if ctx.a.hp < ctx.attacker.health {
                        ...
                        if heal > 0.0 {
                            ...
                            *regen_healed_a += healed;
                            // Round 37 / A7: accumulate for OnHeal trigger.

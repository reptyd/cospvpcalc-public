...
// Phase 6 / G6: resolve a user-defined status spec by id. Gated on the
...
pub fn compute_simple_dot_damage(max_hp: f64, status_id: &str, stacks: f64, tick_sec: f64) -> f64 {
    ...
    // Phase 6 / G6: user statuses compute DoT parametrically from the spec
...
pub fn handle_simple_dot_ticks_full(
    ...
    for (key, instance) in statuses.iter_mut() {
        ...
        // Phase 6 / G6: user-defined heal-over-time tick. Symmetric to the

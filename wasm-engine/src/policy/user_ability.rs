        ...
        other => {
            ...
            if let Some(id) = other.strip_prefix("status_block.") {
                ...
                let plushie = side
                    ...
                    .copied()
                    .unwrap_or(0.0);
                let elder = side.stats.elder_block_fraction.max(0.0);
                return (resist + plushie + elder).clamp(0.0, 1.0);
            }
...
mod tests {
    ...
    fn sample_spec() -> UserAbilitySpec {
        UserAbilitySpec {
            ...
            // utility = self.bite_dps x 8 when off cooldown, else 0.
            utility: Expr::If {
    ...
    fn user_decision_implements_trait_correctly() {
        ...
        // Utility = bite_dps x 8 = (100 / 2.0) x 8 = 400.

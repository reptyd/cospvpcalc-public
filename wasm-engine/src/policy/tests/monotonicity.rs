//! Pillar 5.2 — monotonicity invariant.
//!
...
//!
//! 0 % tolerance per the pillars doc. If Ideal ever produces a
...
//! soak up cooldown-rounding and discrete-tick noise. The pillar is
